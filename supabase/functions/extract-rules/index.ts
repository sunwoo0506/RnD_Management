...
const REF_DESCRIPTION = '근거 위치. 문서에 조·항·호·목 번호가 있으면 그 번호만 그대로 쓴다 (예: "제65조 제7항", "지침 11.다.1)", "Ⅲ-2-나"). 번호가 없으면 표 제목이나 소제목을 20자 이내로 짧게 쓴다 (예: "사업비 구성표", "QnA 사업비 4번"). 목차 경로 전체를 이어붙이지 말 것 (나쁜 예: "붙임2-5 1. 세부 지원내용 - 주요 연구개발비 산정기준").';
